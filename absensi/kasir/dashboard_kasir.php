    ...
    <div class="card info-card slide-up delay-1" style="background:var(--card-bg);">
        <div class="info-card-content">
            <?php if(!$absen_hari_ini): ?>
                ...
                <a href="absen_kasir.php" style="background:var(--primary); color:white; padding:12px 25px; border-radius:12px; text-decoration:none; font-weight:bold; width:100%; box-shadow:0 4px 15px rgba(88, 86, 214, 0.3); transition:0.2s;"><i class="fas fa-sign-in-alt"></i> Absen Masuk Sekarang</a>
            <?php elseif($absen_hari_ini['waktu_keluar'] == NULL): ?>
                ...
                <a href="absen_kasir.php" style="background:var(--warning); color:white; padding:12px 25px; border-radius:12px; text-decoration:none; font-weight:bold; width:100%; box-shadow:0 4px 15px rgba(255, 149, 0, 0.3); transition:0.2s;"><i class="fas fa-sign-out-alt"></i> Absen Pulang (Selesai)</a>
            <?php else: ?>
